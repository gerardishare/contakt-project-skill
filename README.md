...
- `SKILL.md`: de volledige workflow en output-template (bron van waarheid)
- `references/`: extra referenties/templates waar `SKILL.md` naar verwijst
- `agents/`: optioneel (alleen relevant als je eigen agent-configs toevoegt)

## Installatie (zip + upload als Vaardigheid/Skill in ChatGPT)
